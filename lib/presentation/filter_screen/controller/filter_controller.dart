...
import 'package:escan/presentation/filter_screen/models/filter_model.dart';
...
class FilterController extends GetxController {
  ...
  onSelected(dynamic value) {
    ...
    filterModelObj.value.dropdownItemList.value.forEach((element) {
  ...
  onSelected1(dynamic value) {
    ...
    filterModelObj.value.dropdownItemList1.value.forEach((element) {
      element.isSelected = false;
      if (element.id == value.id) {
        element.isSelected = true;
      }
  ...
  onSelected2(dynamic value) {
    ...
    filterModelObj.value.dropdownItemList2.value.forEach((element) {
      element.isSelected = false;
      if (element.id == value.id) {
        element.isSelected = true;
      }
  ...
  onSelected3(dynamic value) {
    ...
    filterModelObj.value.dropdownItemList3.value.forEach((element) {
      element.isSelected = false;
      if (element.id == value.id) {
        element.isSelected = true;
      }
  ...
  onSelected4(dynamic value) {
    ...
    filterModelObj.value.dropdownItemList4.value.forEach((element) {
      element.isSelected = false;
      if (element.id == value.id) {
        element.isSelected = true;
      }
