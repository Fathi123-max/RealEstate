import 'package:get/get.dart';import 'listimg_item_model.dart';import 'listbeds_item_model.dart';import 'package:escan/data/models/selectionPopupModel/selection_popup_model.dart';import 'chipviewhome_item_model.dart';import 'options2_item_model.dart';class FilterModel {Rx<List<ListimgItemModel>> listimgItemList = Rx(List.generate(2,(index) => ListimgItemModel()));
