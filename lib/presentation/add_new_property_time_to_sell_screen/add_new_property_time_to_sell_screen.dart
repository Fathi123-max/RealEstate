...
class AddNewPropertyTimeToSellScreen
    extends GetWidget<AddNewPropertyTimeToSellController> {
  @override
                ...
                child: Column(
                    ...
                    children: [
                      Row(
                          ...
                          children: [
                            Padding(
                                ...
                                child: Text("lbl_time_to_sell".tr,
                      ...
                      Padding(
                          ...
                          child: Text("msg_how_soon_do_you".tr,
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.left,
                      ...
                      CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: controller.durationOneController,
                          hintText: "lbl_within_1_month".tr,
                          margin: getMargin(top: 8),
                          variant: TextFormFieldVariant.OutlineGray300,
                          fontStyle:
                              TextFormFieldFontStyle.ManropeSemiBold14Gray900),
                      CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: controller.durationTwoController,
                          hintText: "lbl_within_2_months".tr,
                          margin: getMargin(top: 8),
                          variant: TextFormFieldVariant.OutlineGray300,
                          fontStyle:
                              TextFormFieldFontStyle.ManropeSemiBold14Gray900),
                      CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: controller.durationThreeController,
                          hintText: "msg_in_more_than_2".tr,
                          margin: getMargin(top: 8),
                          variant: TextFormFieldVariant.OutlineGray300,
                          fontStyle:
                              TextFormFieldFontStyle.ManropeSemiBold14Gray900),
                      CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: controller.streetaddressOneController,
                          hintText: "lbl_i_m_not_sure".tr,
