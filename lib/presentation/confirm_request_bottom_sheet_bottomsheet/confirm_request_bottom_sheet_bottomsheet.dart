import '../confirm_request_bottom_sheet_bottomsheet/widgets/gridhome_item_widget.dart';
...
class ConfirmRequestBottomSheetBottomsheet extends StatelessWidget {
  ConfirmRequestBottomSheetBottomsheet(this.controller);
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Row(children: [
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 67, top: 10, bottom: 4),
                      ...
                      Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                    padding:
                                        getPadding(left: 11, top: 5, bottom: 1),
                                    child: Column(
                                        crossAxisAlignment:
                                ...
                                CustomButton(
                                    ...
                                    text: "lbl_4_8_9".tr,
                                    margin:
                                        getMargin(left: 4, top: 4, bottom: 30),
                      ...
                      Container(
                          ...
                          margin: getMargin(left: 1, top: 25, right: 5),
                          child: RichText(
                              text: TextSpan(children: [
                                TextSpan(
                                    text: "msg_my_associate_ra2".tr,
                                    style: TextStyle(
                      ...
                      Container(
                          ...
                          child: Text("msg_if_you_d_like_t".tr,
                              maxLines: null,
                              textAlign: TextAlign.left,
                      ...
                      Padding(
                          ...
                          child: Text("lbl_highlights".tr,
                              ...
                              style: AppStyle.txtManropeBold18.copyWith(
                                  letterSpacing: getHorizontalSize(0.2)))),
                      Padding(
                          padding: getPadding(top: 13, bottom: 24),
                          child: Obx(() => GridView.builder(
                              shrinkWrap: true,
                              gridDelegate:
                                  SliverGridDelegateWithFixedCrossAxisCount(
                                      mainAxisExtent: getVerticalSize(65),
                                      crossAxisCount: 2,
                              ...
                              itemBuilder: (context, index) {
                                GridhomeItemModel model = controller
                                    .confirmRequestBottomSheetModelObj
                                    .value
                                    .gridhomeItemList
                                    .value[index];
                                return GridhomeItemWidget(model);
                              })))
                    ]))));
  }
