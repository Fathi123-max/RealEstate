    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                centerTitle: true,
                title: AppbarSubtitle(text: "lbl_my_home".tr)),
            body: Container(
                    ...
                    children: [
                      Obx(() => ListView.separated(
                          ...
                          itemCount: controller
                              .myHomeModelObj.value.myHomeItemList.value.length,
                          itemBuilder: (context, index) {
                            MyHomeItemModel model = controller.myHomeModelObj
                                .value.myHomeItemList.value[index];
                            return MyHomeItemWidget(model, onTapProperty: () {
                              onTapProperty();
                            });
                          })),
                      CustomButton(
