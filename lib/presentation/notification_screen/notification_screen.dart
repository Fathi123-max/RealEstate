                    ...
                    children: [
                          ...
                          child: Obx(() => ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ListhomeItemModel model = controller
                                    ...
                                    .listhomeItemList
                                    .value[index];
                                return ListhomeItemWidget(model);
                              }))),
                      Padding(
                      ...
                      Padding(
                          ...
                          child: Obx(() => ListView.separated(
                              ...
                              itemCount: controller.notificationModelObj.value
                                  .listchartlineItemList.value.length,
                              itemBuilder: (context, index) {
                                ListchartlineItemModel model = controller
                                    .notificationModelObj
                                    .value
                                    .listchartlineItemList
                                    .value[index];
                                return ListchartlineItemWidget(model);
                              })))
                    ]))));
  }
